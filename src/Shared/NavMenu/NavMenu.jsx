    ...
    <div className="container mx-auto bg-white border-b border-zinc-300 flex justify-between items-center">
      ...
      <div className="flex items-center">
        ...
        <nav className="hidden lg:flex items-start gap-5 ml-5">
          ...
          <Link to='/solutions' className="text-black text-lg font-normal font-['Open Sans'] cursor-pointer hover:underline">Solutions</Link>
          <Link to='/resources' className="text-black text-lg font-normal font-['Open Sans'] cursor-pointer hover:underline">Resources</Link>
