        ...
        <>
            <div className="max-w-5xl mx-auto mt-12">
                ...
                <div className="text-center relative">
                    ...
                    <div className="bg-[#FFD02F] uppercase p-2 font-sans text-xs text-[#090909] absolute object-right-top -top-12 right-12	lg:-top-10 lg:right-64 transform rotate-12  font-bold px-2 py-1 rounded-full">
